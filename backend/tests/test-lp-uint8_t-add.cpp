...
int main(void) {
  ...
  //// instantiate the Circuit Repository
	...
	std::vector<std::vector<ContextLP<uint8_t>::Plaintext>> pt_input = {{15, 10, 10, 8, 80}, {22, 12, 0, 8, 80}};

	std::vector<std::vector<ContextLP<uint8_t>::Plaintext>> result = ctx.eval_with_plaintexts(circ, pt_input, durations);
