 ...
 * In practice, even after the Azure portal said it was available and healthy,  it took a long time (about 5 mins) to respond when I first tried to access it through my browser, but after that it worked OK.
